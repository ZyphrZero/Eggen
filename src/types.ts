...
export interface CustomProviderBalanceMapping {
  /** 解释该查询协议的模板 id，例如 volcengine-billing */
  template: string
  /** 模板自定义参数，例如 region / action / version */
...
export interface CustomProviderDefinition {
  ...
  /** 服务商可选模型。存在时，配置页使用下拉框而不是自由输入。 */
  models?: CustomProviderModel[]
  /** 可选的账户用量/余额查询能力，具体协议由 balance.template 指定的模板解释 */
  balance?: CustomProviderBalanceMapping
}
