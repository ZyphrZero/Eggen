...
用于描述生成图像的内容，模型根据提示词生成对应图像。（查看提示词指南：[Seedream 4.0-5.0 提示词指南](https://ark.volcengine.com/region:cn-beijing/docs/82379/1829186?lang=zh)）
...
<div data-tips="true" data-tips-type="warning"><code>1.5K</code> 与 <code>1K</code> 价格相同（详情参见 <a href="https://ark.volcengine.com/region:cn-beijing/docs/82379/1544106?lang=zh#457edfd0">模型价格</a>），且图片生成效果更优。</div>
...
<div data-tips="true" data-tips-type="warning"><code>1.5K</code> 与 <code>1K</code> 价格相同（详情参见 <a href="https://ark.volcengine.com/region:cn-beijing/docs/82379/1544106?lang=zh#457edfd0">模型价格</a>）。</div>
...
组图输出示例详见 [Seedream 图像创作教程 - 组图输出](https://ark.volcengine.com/region:cn-beijing/docs/82379/1824121?lang=zh#ec79cfda)。
...
流式输出示例详见 [Seedream 图像创作教程 - 流式输出](https://ark.volcengine.com/region:cn-beijing/docs/82379/1824121?lang=zh#e5bef0d7)。
...
您需要调用的模型的 ID（Model ID），[开通模型服务](https://ark.volcengine.com/region:cn-beijing/openManagement?LLM=%7B%7D&OpenTokenDrawer=false)，并 [查询 Model ID](https://ark.volcengine.com/region:cn-beijing/docs/82379/1330310?lang=zh#9df4d9fd)。
...
错误码，请参见 [错误码](https://ark.volcengine.com/region:cn-beijing/docs/82379/1299023?lang=zh)
...
字段结构详见 [图片生成流式响应事件](https://ark.volcengine.com/region:cn-beijing/docs/82379/1824137?lang=zh)。
