...
export default function InputBar() {
  ...
  const activeProfile = useMemo(() => {
    if (appMode === 'agent' || !settings.reuseTaskApiProfileTemporarily || !reusedTaskApiProfileId) return currentActiveProfile
    const profile = settings.profiles.find((item) => item.id === reusedTaskApiProfileId) ?? currentActiveProfile
    return reusedTaskApiModel ? { ...profile, model: reusedTaskApiModel } : profile
  }, [appMode, currentActiveProfile, reusedTaskApiProfileId, reusedTaskApiModel, settings])
